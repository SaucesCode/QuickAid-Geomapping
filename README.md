...
- 📊 **Analytics Dashboard:** Track KPIs such as total applicants, trends over time, demographic distribution, top barangays, and processing performance.
- 🔎 **Advanced Filtering:** Search and filter applicants using geographic, demographic, economic, or time-based criteria.
- 👨‍💼 **Staff Management:** Admin-controlled staff accounts, profile updates, password changes, and activity logs.
- 📥 **Public Submission & QR:** Multi-step public form with QR code support for staff-linked submissions.
