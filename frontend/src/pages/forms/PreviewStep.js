        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="p-4 sm:p-8 space-y-6 sm:space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-4 sm:p-6">
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Full Name</div>
                  <div className="text-base font-medium text-gray-800">{getFullName()}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Birthday</div>
                  <div className="text-base font-medium text-gray-800">{formData.birthday}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Sex</div>
                  <div className="text-base font-medium text-gray-800">{formData.sex}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Civil Status</div>
                  <div className="text-base font-medium text-gray-800">{formData.civil_status}</div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-4 sm:p-6">
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Contact Number</div>
                  <div className="text-base font-medium text-gray-800">{formData.contact_number}</div>
                </div>
                <div className="space-y-1 md:col-span-2"> {/* Address spans full width on desktop */}
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Address</div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-4 sm:p-6">
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Occupation</div>
                  <div className="text-base font-medium text-gray-800">{formData.occupation}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Monthly Income</div>
                  <div className="text-base font-medium text-gray-800">{formatCurrency(formData.monthly_income)}</div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-4 sm:p-6">
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Valid ID Presented</div>
                  <div className="text-base font-medium text-gray-800">{formData.valid_id_presented}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Applicant Type</div>
                  <div className="text-base font-medium text-gray-800">{formData.applicant_type}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Assistance Type</div>
                  <div className="text-base font-medium text-gray-800">{formData.type_of_assistance}</div>
                </div>
              </div>
            </section>
              ...
              <>
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-gradient-to-br from-amber-50 to-white border border-amber-200 rounded-xl p-4 sm:p-6">
                    <div className="space-y-1">
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Representative Name</div>
                    ...
                    <div className="space-y-1">
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Relationship to Applicant</div>
                      <div className="text-base font-medium text-gray-800">{formData.rep_relationship}</div>
                    </div>
                    <div className="space-y-1 md:col-span-2"> {/* Address spans full width on desktop */}
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Representative Address</div>
                      <div className="text-base font-medium text-gray-800">{formData.rep_address}</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Representative Birthday</div>
                      <div className="text-base font-medium text-gray-800">{formData.rep_birthday}</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Representative Sex</div>
                      <div className="text-base font-medium text-gray-800">{formData.rep_gender}</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Representative Civil Status</div>
                      <div className="text-base font-medium text-gray-800">{formData.rep_civil_status}</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Representative Occupation</div>
                      <div className="text-base font-medium text-gray-800">{formData.rep_occupation}</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide">Representative Monthly Income</div>
                      <div className="text-base font-medium text-gray-800">
