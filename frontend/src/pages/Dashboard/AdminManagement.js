    ...
    <div className={`p-4 sm:p-6 lg:p-8 bg-${theme.background} min-h-screen font-sans`}>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8">
          <div>
            <h1 className={`text-3xl md:text-4xl font-extrabold text-${theme.textPrimary} flex items-center gap-3`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className={`bg-${theme.surface} shadow-lg rounded-2xl ${responsivePadding} border border-gray-100 transition-shadow duration-300 hover:shadow-xl`}>
            <div className="flex items-center justify-between">
              <div>
                <p className={`text-sm font-medium text-${theme.textSecondary}`}>Total Staff</p>
                    ...
                    <thead>
                      <tr className="border-b border-gray-100 bg-gray-50/50">
                        {["Status", "Username", "Full Name", "Email", "Actions"].map(header => (
                          <th key={header} className={`px-4 py-3 text-left font-medium text-${theme.textSecondary} first:rounded-tl-xl last:rounded-tr-xl`}>
                            {header}
                          </th>
                        ))}
                      </tr>
                      ...
                      {staffList && staffList.length > 0 ? (
                        staffList.map(staff => (
                          ...
                          >
                            ...
                            <td className={`px-4 py-3.5 font-medium text-${theme.textPrimary}`}>{staff.username}</td>
            ...
            {isLoadingHistory ? (
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-100 bg-gray-50/50">
                      <th className={`px-4 py-3 text-left font-medium text-${theme.textSecondary}`}>File</th>
                      <th className={`px-4 py-3 text-left font-medium text-${theme.textSecondary}`}>Uploaded By</th>
                      <th className={`px-4 py-3 text-left font-medium text-${theme.textSecondary}`}>Date</th>
                      <th className={`px-4 py-3 text-center font-medium text-${theme.textSecondary}`}>Processed</th>
                      <th className={`px-4 py-3 text-center font-medium text-${theme.textSecondary}`}>Approved</th>
                      <th className={`px-4 py-3 text-center font-medium text-${theme.textSecondary} whitespace-nowrap`}>Already Approved</th>
                      <th className={`px-4 py-3 text-center font-medium text-${theme.textSecondary} whitespace-nowrap`}>Not Found</th>
                    </tr>
                  </thead>
                  <tbody>
                    {approvalHistory.map(batch => (
                      <tr
                        ...
                        className={`border-b border-gray-50 last:border-b-0 hover:bg-${theme.background} transition-colors`}
                      >
                        <td className={`px-4 py-3.5 font-medium text-${theme.textPrimary} flex items-center gap-2`}>
                          <FileText className={`w-4 h-4 text-${theme.primary}`} />
                          {batch.file_name}
                        </td>
                        <td className={`px-4 py-3.5 text-${theme.textSecondary}`}>{batch.uploaded_by}</td>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 p-4 transition-opacity duration-300">
            <div className={`bg-${theme.surface} rounded-2xl shadow-2xl w-full max-w-lg transition-transform duration-300 scale-100`}>
              {/* Modal Header */}
              ...
              <div className="p-6 space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="form-control">
                    <label className={`block text-sm font-medium text-${theme.textPrimary} mb-1`}>First Name</label>
                  ...
                  <div className="form-control">
                    <label className={`block text-sm font-medium text-${theme.textPrimary} mb-1`}>Last Name</label>
                    <div className="relative">
                      <input
                        name="last_name"
                ...
                <div className="form-control">
                  <label className={`block text-sm font-medium text-${theme.textPrimary} mb-1`}>Email Address</label>
                  <div className="relative">
                    <input
                      name="email"
                      type="email"
                ...
                <div className="form-control">
                  <label className={`block text-sm font-medium text-${theme.textPrimary} mb-1`}>Username</label>
                  <div className="relative">
                    <input
                      name="username"
                      ...
                      className={`w-full p-2.5 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-${theme.primary} focus:border-${theme.primary} text-sm text-${theme.textPrimary}`}
                    />
                    <UserPlus className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-${theme.textSecondary}`} />
                  </div>
                </div>

                <div className="form-control">
                  <label className={`block text-sm font-medium text-${theme.textPrimary} mb-1`}>Password</label>
                  <div className="relative">
                    <input
                      name="password"
          ...
          <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 p-4 transition-opacity duration-300">
            <div className={`bg-${theme.surface} rounded-2xl shadow-2xl w-full max-w-lg transition-transform duration-300 scale-100`}>
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="form-control">
                  <label className={`block text-sm font-medium text-${theme.textPrimary} mb-1`}>New Password (Optional)</label>
                  <div className="relative">
                    <input
                      name="password"
