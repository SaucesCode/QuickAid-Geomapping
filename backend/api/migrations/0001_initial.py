# Generated by Django 5.2.6 on 2025-10-26 13:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_valid_id', models.CharField(blank=True, max_length=255, null=True)),
                ('applicant_type', models.CharField(choices=[('Self', 'Self'), ('Representative', 'Representative')], default='Self', max_length=20)),
                ('type_of_assistance', models.CharField(choices=[('Medical', 'Medical'), ('Burial', 'Burial'), ('Educational', 'Educational')], max_length=50)),
                ...
                ('background_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.backgroundinfo')),
            ],
        ),
        migrations.CreateModel(
            name='ApprovalBatch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applicant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='api.applicant')),
                ...
                ('batch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='api.approvalbatch')),
            ],
        ),
        migrations.CreateModel(
