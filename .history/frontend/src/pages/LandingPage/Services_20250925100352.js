            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 text-sm mb-6">
                  Support for students in need of financial assistance for
                  educational expenses including tuition, school supplies, and
                  other academic needs.
                </p>
                <Link
                  to="/services/education"
                  className="inline-block bg-gray-100 hover:bg-gray-200 text-gray-800 px-6 py-2 rounded-lg transition-colors"
                >
                  Learn More
                </Link>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm mb-6">
                  Healthcare support for individuals and families facing medical
                  emergencies and treatment needs.
                </p>
                <Link
                  to="/services/medical"
                  className="inline-block bg-gray-100 hover:bg-gray-200 text-gray-800 px-6 py-2 rounded-lg transition-colors"
              ...
              >
                ...
                <p className="text-gray-600 text-sm mb-6">
                  Financial support for families dealing with funeral and burial
