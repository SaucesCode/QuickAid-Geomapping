        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="text-6xl font-bold text-teal-600 mb-4">3k+</div>
            ...
            <div>
              ...
              <div className="flex items-center justify-center space-x-6">
                {/* Left Arrow */}
                <div className="w-0 h-0 border-r-4 border-r-gray-300 border-t-2 border-b-2 border-t-transparent border-b-transparent"></div>
