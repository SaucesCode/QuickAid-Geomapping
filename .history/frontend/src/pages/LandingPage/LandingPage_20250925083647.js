...
const heroImage =
  "https://via.placeholder.com/600x400/f3f4f6/374151?text=AICS+Services";
const educIcon =
  "https://via.placeholder.com/60x60/3b82f6/ffffff?text=📚";
const medicalIcon =
  "https://via.placeholder.com/60x60/10b981/ffffff?text=🏥";
const burialIcon =
  "https://via.placeholder.com/60x60/6366f1/ffffff?text=⚰️";
...
const beneficiaries = [
  ...
  },
  {
    ...
    icon: <Cross className="w-12 h-12 text-white" />,
  },
];
...
const services = [
  ...
  },
  {
    ...
    desc: "Funeral and burial service support",
  },
];
...
const LandingPage = () => {
  ...
  return (
    <div className="font-sans min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                <span className="text-blue-600">Assistance</span> to Individuals in{" "}
                <span className="text-blue-600">Crisis</span> Situation
              </h1>

              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                AICS is a DSWD program providing medical, burial, transport,
                education, food, and financial aid to individuals or families in
                crisis situations.
              </p>
      ...
      {/* Who We Serve Section (Updated with Lucide icons) */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Our application management system is designed to assist a diverse
              range of beneficiaries in need of support.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {beneficiaries.map((beneficiary, index) => (
              ...
              >
                <div className="flex justify-center items-center w-16 h-16 mx-auto mb-6 bg-white/20 rounded-full">
                  {beneficiary.icon}
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
              Thousands of individuals and families in crisis
              <br />
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Find answers to common questions about the AICS program and
              application process.
            </p>
          </motion.div>
